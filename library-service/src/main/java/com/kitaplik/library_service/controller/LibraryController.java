...
import com.kitaplik.library_service.dto.UpdateProgressRequest;
...
public class LibraryController {
    ...
    public ResponseEntity<LibraryDto> getLibraryById(@PathVariable String id) {
        return ResponseEntity.ok(libraryService.getAllBooksInLibraryId(id));
    }
    ...
    // YENİ ENDPOINT: Okuma Sayfası, Statü, Puan ve Not Güncelleme
    // Kullanım: PUT /v1/library/{libraryId}/item/{itemId}/progress
    @PutMapping("/{libraryId}/item/{itemId}/progress")
    public ResponseEntity<LibraryDto> updateReadingProgress(
            @PathVariable String libraryId,
            @PathVariable String itemId,
            @RequestBody UpdateProgressRequest request) {
        return ResponseEntity.ok(libraryService.updateReadingProgress(libraryId, itemId, request));
    }
